...
translation efficiency of target genes in \emph{UAS}-\emph{tkv}, \emph{bam} RNAi, and
...
\emph{bam} RNAi, and (\textbf{I-I'}) \emph{aramis} RNAi (yellow dashed line marks
approximate region of germline used for quantification). (\textbf{J}) A.U.
...
\emph{p53\textsuperscript{5-A-14}} compared to the \emph{p53} wildtype control (n=35-55 germaria
