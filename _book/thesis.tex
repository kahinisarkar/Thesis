...
(ref:RiBi-F2-1-short)
\begin{flushleft} RNA helicases Aramis, Athos and Porthos are required for GSC differentiation. \end{flushleft}

(ref:RiBi-F2-2-short)
\begin{flushleft} Aramis, Athos, and Porthos are required for proper cytokinesis and differentiation, related to Figure 2.1. \end{flushleft}

(ref:RiBi-F2-3-short)
\begin{flushleft} Athos, Aramis, and Porthos are required for efficient ribosome biogenesis. \end{flushleft}

(ref:RiBi-F2-4-short)
\begin{flushleft} Athos, Aramis, and Porthos are required for efficient ribosome biogenesis., related to Figure 2.3. \end{flushleft}

(ref:RiBi-F2-5-short)
\begin{flushleft} Athos, Aramis, and Porthos are required for cell cycle progression during early oogenesis. \end{flushleft}

(ref:RiBi-F2-6-short)
\begin{flushleft} Aramis is required for proper cell cycle progression, related to Figure 2.5. \end{flushleft}

(ref:RiBi-F2-7-short)
\begin{flushleft} Aramis is required for efficient translation of a subset of mRNAs. \end{flushleft}

(ref:RiBi-F2-8-short)
\begin{flushleft} The mRNA levels of Aramis polysome-seq targets are not significantly changing, related to Figure 2.7. \end{flushleft}

(ref:RiBi-F2-9-short)
\begin{flushleft} Non1 represses p53 expression to allow for GSC differentiation. \end{flushleft}

(ref:RiBi-F2-10-short)
\begin{flushleft} Non1 and p53 are inversely expressed, related to Figure 2.9. \end{flushleft}

(ref:RiBi-F2-11-short)
\begin{flushleft} Aramis regulated mRNAs contain a TOP motif. \end{flushleft}

(ref:RiBi-F2-12-short)
\begin{flushleft} TORC1 activity, Athos, and Porthos, regulate TOP expression in the germarium, related to Figure 2.11. \end{flushleft}

(ref:RiBi-F2-13-short)
\begin{flushleft} Larp binds to TOP mRNAs and binding is regulated by Aramis. \end{flushleft}

(ref:RiBi-F2-14-short)
\begin{flushleft} Larp binds specifically to TOP containing mRNAs and regulates cytokinesis, related to Figure 2.13. \end{flushleft}
...
\caption[(ref:RiBi-F2-1-short)]{(ref:RiBi-F2-1-short)}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption[(ref:RiBi-F2-2-short)]{(ref:RiBi-F2-2-short)}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption[(ref:RiBi-F2-3-short)]{(ref:RiBi-F2-3-short)}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption[(ref:RiBi-F2-4-short)]{(ref:RiBi-F2-4-short)}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption[(ref:RiBi-F2-5-short)]{(ref:RiBi-F2-5-short)}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption[(ref:RiBi-F2-6-short)]{(ref:RiBi-F2-6-short)}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption[(ref:RiBi-F2-7-short)]{(ref:RiBi-F2-7-short)}\label{fig:unnamed-chunk-12}
\end{figure}
...
\caption[(ref:RiBi-F2-8-short)]{(ref:RiBi-F2-8-short)}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption[(ref:RiBi-F2-9-short)]{(ref:RiBi-F2-9-short)}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption[(ref:RiBi-F2-10-short)]{(ref:RiBi-F2-10-short)}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption[(ref:RiBi-F2-11-short)]{(ref:RiBi-F2-11-short)}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption[(ref:RiBi-F2-12-short)]{(ref:RiBi-F2-12-short)}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption[(ref:RiBi-F2-13-short)]{(ref:RiBi-F2-13-short)}\label{fig:unnamed-chunk-18}
\end{figure}
...
\caption[(ref:RiBi-F2-14-short)]{(ref:RiBi-F2-14-short)}\label{fig:unnamed-chunk-19}
\end{figure}
...
\textbf{Supplemental Table 2.4. Analysis of polysome-seq of ovaries depleted of \emph{aramis} in the germline compared to developmental controls.} Results of polysome-seq from ovaries depleted of \emph{aramis} in the germline, ovaries depleted of \emph{bam}, and ovaries overexpressing tkv in the germline as developmental controls. Sheet 1 (Downregulated Genes) contains genes and corresponding polysome/input ratio values and values representing the difference in the polysome/input ratios between \emph{aramis} RNAi and the developmental controls meeting the cutoffs to be considered downregulated in \emph{aramis} RNAi. Sheet 2 (Upregulated Genes) contains genes and corresponding polysome/input ratio values and values representing the difference in the polysome/input ratios between \emph{aramis} RNAi and the developmental controls meeting the cutoffs to be considered upregulated in \emph{aramis} RNAi. Sheet 3 (All Genes) contains DEseq2 output for all genes in the dm6 assembly.

\textbf{\hfill\break
}

\textbf{Supplemental Table 2.5. Enrichment analysis of Aramis RNA IPmRNA-seq.} Results of Aramis::GFP::FLAG IP/IgG/Input mRNAseq. Each sheet contains the output of results from DEseq2. Sheet 1 (aramis polysome IP Enrichment) contains the enrichment value of all \emph{aramis} polysome targets from Aramis IP. Sheet 2 (aramis polysome IgG Enrichment) contains the enrichment value of all \emph{aramis} polysome targets from Aramis IgG control. Sheet 3 (Aramis IP Targets) contains Aramis IP targets as defined in methods. Sheet 4 (IP vs In Enriched) contains genes significantly enriched in the Aramis IP samples compared to the input samples. Sheet 5 (IgG vs In Enriched) contains genes significantly enriched (see methods) in the IgG samples compared to the input samples. Sheet 6 (IPvsIn All Genes) contains the DEseq2 output of all genes in the Aramis IP samples compared to the input samples. Sheet 7 (IgG vs In All Genes) contains the DEseq2 output of all genes in the IgG samples compared to the input samples.

\textbf{\hfill\break
}

\textbf{Supplemental Table 2.6. Aramis translation targets contain TOP sequences.} Sheet 1 (aramisRNAi target CAGE 5'UTRs) contains the CAGE corrected 5'UTRs of \emph{aramis} RNAi polysome downregulated targets with leading TOP sequences and start codons annotated. Sheet 2 (TOP location) contains a list of \emph{aramis} RNAi polysome downregulated targets and the position and sequence of the first instance of a 5-mer pyrimidine sequence downstream of the CAGE-defined TSS of each gene.
