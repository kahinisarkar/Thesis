...
(\textbf{Figure 2.5A-C'''}) (Ochs, Lischwe, Spohn, \& Busch, 1985). Aramis was
...
rRNA immunopurified with Aramis, Athos, and Porthos \textbf{(Figure 2.5D-D'', Figure 2.4A-A'')}.
...
control flies, consistent with nucleolar stress (\textbf{Figure 2.4B-C'}).
...
the polysome peaks were reduced (\textbf{Figure 2.5E-E''}). We found that
...
defective 40S ribosomal subunit biogenesis (\textbf{Figure 2.5E, E''}, \textbf{Figure
S2D)} (Cheng et al., 2019), whereas \emph{athos} depletion
diminished the height of the 60S subunit peak compared to the 40S peaks,
characteristic of a 60S ribosomal subunit biogenesis defect (\textbf{Figure 2.5E', Figure 2.4D'}) (Cheng et al., 2019).
...
compared to their controls (\emph{Figure 2.5A, Supplemental Table 2.3}). Similarly,
...
RNAi; \emph{aramis} RNAi. (\textbf{Figure 2.6B}, \textbf{Supplemental Table 2.3}). These
