...
(ref:Screen-1-long) \setlength\parindent{0pt}The dual luciferase reporter consists of a Nos promoter and 5'UTR controlling translation initiation of *Renilla* luciferase followed by a read-though stop consisting of hairpins and the CrPV-IGR IRES which controls initiation of Firefly luciferase.
...
translation landscape. To perform this screen, we used the *Drosophila* ovary, as it has several advantages. First, *Drosophila* have thousands
...
*Renilla* luciferase under the control of the Nos 5\'UTR and its
...
[@hertzRibosomalProteinS252013;@landryRPS25EssentialTranslation2009]. There are several
...
phenotype which enriched for stem cells (germline UAS-*tkv*) or stem cell
daughters (germline *bam* RNAi) would alter the relative IRES translation.
...
*nsl-1*, *Lsd1*, *HDAC3*, and *Not*. However, the effect size observed
