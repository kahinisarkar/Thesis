(ref:RiBi-F2-1-short) **SETDB1* and *windei* are required for silencing *RpS19b* reporter during oogenesis**

(ref:RiBi-F2-1-long) (A) A schematic of a *Drosophila* ovariole. The ovariole consists of germarium and egg chambers corresponding to distinct developmental stages. Egg chambers are connected by somatic cells (light red). During development, egg chambers grow and eventually give rise to a mature egg (white). (A1) A schematic of a *Drosophila* germarium, where germline stem cells (GSCs; light green) are at close proximity to somatic niche (red). The GSC divides to give rise to daughter cells called cystoblasts (dark green) which turns on a differentiation program. Both GSCs and cystoblasts are marked by spectrosomes (red). Cystoblasts undergo four incomplete mitotic divisions, giving rise to 2-, 4-, 8-, and 16-cell cysts (green), marked by fusomes (red). During the cyst stages germ cells progress through meiotic cell cycle (prophase I). Upon 16-cell cyst formation, a single cell is specified as the oocyte (dark blue) while the other 15 cells become nurse cells (light blue). (B-B2) Confocal images of a germarium of a fly carrying *RpS19b-GFP* reporter transgene stained for GFP (green, right grayscale), Egl (red, right grayscale) and Vasa (blue). GFP is expressed in the single cells undifferentiated stages and early cyst stages (white dashed line), while Egl is expressed in the differentiated cysts and localized to the specified oocyte (yellow arrows). (C-E) Ovariole of control *RpS19b-GFP* (D-D1), GKD of *SETDB1* (E-E1) and *wde* (F-F1) stained for GFP (green, right grayscale), Vasa (blue) and 1B1 (red). Depletion of these genes resulted in characteristic phenotype of egg chambers not growing and mid oogenesis death (white solid arrows). In addition, ectopic expression of *RpS19b-*GFP was observed in the egg chambers (white dashed line). (F) Quantification of ectopic RpS19b-GFP expression upon GKD of *SETDB1* or *wde* compared to control ovaries (N= 50 ovarioles; 96% in *SETDB1* GKD and 90% in *wde* GKD compared to 0% in control.) Statistical analysis was performed with Fisher\'s exact test on ectopic GFP expression; \*\*\* = p\<0.001. (G) Arbitrary units (A.U.) quantification of RpS19b-GFP expression in the germarium and egg chambers during development upon GKD of *SETDB1* (magenta) or *wde* (orange) compared to control ovaries (black). GFP is expressed higher in single cells in the germarium, decreases in the cyst stages, and then attenuated upon egg chamber formation. In *SETDB1* and *wde* GKD, GFP expression persists in the egg chambers. Statistical analysis was performed with Dunnett\'s multiple comparisons test; N= 10 ovarioles; ns = p\>0.05, \*=p\<0.05, \*\* = p\<0.01, \*\*\* = p\<0.001. Scale bars are 15 micron.
...
generation [@cinalliGermCellsAre2008;@seydouxPathwayTotipotencyLessons2006;@spradlingGermlineStemCells2011a]. In the gonad, germ cells become
germline stem cells (GSCs) that self-renew and differentiate to give
rise to sperm or an oocyte [@gilboaRepressionPrimordialGerm2004;@kershnerGermlineStemCells2013;@koConversionAdultMouse2010;@leschGeneticsGermCell2012;@reikGermlinePluripotentStem2015;@seydouxPathwayTotipotencyLessons2006]. The oocyte, upon fertilization
...
[@ben-amiSpatialTemporalPatterns2005;@lehmannGermlineStemCells2012a;@riparbelliParthenogenesisInsectsCentriole2017;@yuanGermlineStemCells2010]. The gene regulatory mechanisms that
...
(GSC) to an oocyte [@dansereauDevelopmentGermlineStem2008;@gilboaRepressionPrimordialGerm2004;@spradlingDevelopmentalGeneticsOogenesis1993;@spradlingGermlineStemCells2011a]. *Drosophila* ovaries comprise
...
[@chenDiscreteTranscriptionalSilencer2003;@chenDppSignalingSilences2003;@xieControlGermlineStem2013a]. One of
these 16 cells is specified as the oocyte whereas the other 15 cells
become nurse cells [@huynhOriginAsymmetryEarly2004;@kochDivisionDifferentiationDrosophila1967;@navarroEgalitarianBindsDynein2004a]. Somatic cells envelop the nurse
...
[@blattPosttranscriptionalGeneRegulation2020;@kuglerLocalizationAnchoringTranslational2009;@lillyDrosophilaEndocycleControlled1996;@machEgalitarianBicaudalDComplexEssential1997a;@navarroEgalitarianBindsDynein2004a;@spradlingGermlineCystsCommunes1993]. An inability to specify or
maintain the oocyte fate leads to death of the egg chamber mid-oogenesis
and, in turn, sterility [@blattRNADegradationRequired2021;@navarroEgalitarianBindsDynein2004a].
...
[@mckearinRoleDrosophilaBagofmarbles1995;@mckearinBagofmarblesDrosophilaGene1990]. In the 8-cell cyst, the
...
[@ablesDrosophilaOocytesModel2015;@cahoonRegulatingConstructionDemolition2016;@hughesFemaleMeiosisSynapsis2018;@orr-weaverMeiosisDrosophilaSeeing1995;@pageEncodesDrosophilaSynaptonemal2001a]. More than one cell in the
...
(**Figure 1A1**) [@ablesDrosophilaOocytesModel2015;@orr-weaverMeiosisDrosophilaSeeing1995;@pageEncodesDrosophilaSynaptonemal2001a]. After oocyte-specification,
...
formation [@cloughEpigeneticRegulationOogenesis2014;@cloughHistoneMethylationRequired2007a;@ranganPiRNAProductionRequires2011a;@yoonDSETDB1SUVAR2008]. SETDB1
...
loci [@kochWindeiDrosophilaHomolog2009;@osumiEssentialRolesWindei2019]. Loss of *SETDB1* during germline
development results in an accumulation of undifferentiated cells
[@ranganPiRNAProductionRequires2011a;@smolkoH3K9MethyltransferaseSETDB12018]. In addition, loss of *SETDB1*
and *wde* also result in egg chambers that do not grow in size and die
mid-oogenesis [@cloughEpigeneticRegulationOogenesis2014;@kochWindeiDrosophilaHomolog2009]. *SETDB1* is known to be required
for silencing transposons and male-specific transcripts in the female
germline [@czechPiRNAGuidedGenomeDefense2018;@ranganPiRNAProductionRequires2011a;@smolkoH3K9MethyltransferaseSETDB12018]. However, neither the
upregulation of transposons nor male-specific genes in female germline
result in egg chambers that do not grow in size
[@maloneSpecializedPiRNAPathways2009;@shapiro-kulnaneMaintenanceDrosophilaGermline2015;@smolkoAutoregulatorySwitchSexspecific2020]. Together these data
...
```{r, fig.align="center", include=TRUE, out.width="98%", fig.align="center", fig.scap="(ref:RiBi-F2-1-short)", echo=FALSE}
...
4A**)[@andersenHeterochromatindependentTranscriptionMachinery2017;@cloughHistoneMethylationRequired2007a;@kochWindeiDrosophilaHomolog2009;@ranganPiRNAProductionRequires2011a].
...
[@capelsonNuclearPoreComplexes2010;@doucetNuclearPoreBiogenesis2010;@gozaloNewPathNuclear2016]. Beyond regulating nucleocytoplasmic
transport, NPCs also regulate gene transcription, for instance by
anchoring and maintaining heterochromatic domains
[@capelsonRoleNuclearPores2009;@houNupsTakeLeave2010;@iglesiasNativeChromatinProteomics2020;@sarmaNewNucleoporinRegulator2012;@soodNuclearPoreInteractions2014].
...
[@colozzaDrosophilaNucleoporinNup1542011;@gigliottiNup154NewDrosophila1998;@grimaldiNup154GeneticallyInteracts2007]. The Nups that were
...
[@capelsonChromatinboundNuclearPore2010;@davisNuclearPoreComplex1987;@hampoelzNuclearPoresAssemble2019;@kuhnChromatinTargetingNuclear2019]. We found that NPC levels were
...
promote their transcription [@ranganPiRNAProductionRequires2011a;@weilerHeterochromatinGeneExpression1995]. Although we found that
...
[@katsaniVivoDynamicsDrosophila2008a;@ranganPiRNAProductionRequires2011a]. We found that H3K9me3 domains
...
[@gigliottiNup154NewDrosophila1998;@grimaldiNup154GeneticallyInteracts2007]. We found that GKD of
...
[@machEgalitarianBicaudalDComplexEssential1997a;@navarroEgalitarianBindsDynein2004a]. In the early stages of
...
development after fertilization [@calviCellCycleControl1998;@huynhOriginAsymmetryEarly2004;@kuglerLocalizationAnchoringTranslational2009;@navarroEgalitarianBindsDynein2004a;@telferDevelopmentPhysiologyOocyteNurse1975]. We previously showed
...
is detrimental to oogenesis [@blattRNADegradationRequired2021;@duanNuclearArchitectureIntrinsic2020]. Remarkably, some of the mRNAs
...
by piRNAs
[@andersenHeterochromatindependentTranscriptionMachinery2017;@czechPiRNAGuidedGenomeDefense2018;@kochWindeiDrosophilaHomolog2009;@osumiEssentialRolesWindei2019]. However, our data suggests that the
...
that do not grow [@chenCutoffAubergineMutations2007;@wilsonAubergineEnhancesOskar1996]. In somatic cells of the gonad,
loss of *wde* function eliminates nuclear SETDB1 signal
[@osumiEssentialRolesWindei2019;@timmsATF7IPMediatedStabilizationHistone2016]. However, upon depletion
...
[@frietzeZNF274RecruitsHistone2010;@schultzSETDB1NovelKAP1associated2002]. Thus, SETDB1 targets germ cell
...
[@capelsonChromatinboundNuclearPore2010;@capelsonNuclearPoreComplexes2010;@hollaPositioningHeterochromatinNuclear2020;@iglesiasNativeChromatinProteomics2020;@sarmaNewNucleoporinRegulator2012]. In addition, in yeast, several
...
[@bricknerRoleTranscriptionFactors2019;@iglesiasNativeChromatinProteomics2020]. Consistent with these
...
[@guttingerOrchestratingNuclearEnvelope2009b;@laurellDismantlingNPCPermeability2011]. Nucleoporins are recruited to
the chromatin in early anaphase followed by sequential reassembly of the
complex [@kiselevaStepsNuclearPore2001;@kutayMitoticDisassemblyReassembly2021]. During *Drosophila*
oogenesis, in the premeiotic stage, the GSC divides to eventually
produce a 16-cell cyst [@huynhOriginAsymmetryEarly2004;@kochDivisionDifferentiationDrosophila1967;@lehmannGermlineStemCells2012a;@spradlingGermlineStemCells2011a].
Prophase-I of meiosis begins in cysts where the oocyte is also specified
[@ablesDrosophilaOocytesModel2015;@orr-weaverMeiosisDrosophilaSeeing1995]. We find that nucleoporins
...
[@andersenHeterochromatindependentTranscriptionMachinery2017;@devlinOrganizationExpressionLight1990;@ranganPiRNAProductionRequires2011a]. However, by analyzing CUT &RUN
...
TRIzol (Invitrogen, 15596026) [@blattRNADegradationRequired2021;@mccarthyMSL3CoordinatesTranscriptional2019a].
