[Post-transcriptional gene regulation instructs germline stem cell to
oocyte transition during *Drosophila* oogenesis]{.underline}
...
2.  Alternative splicing ensures accurate production of critical
    germline mRNAs to regulate sex determination and differentiation

3.  RNA modifications direct splicing of sex determinants and
    translation of differentiation promoting genes in the germline

4.  Production of ribosomes is finely tuned to facilitate
    differentiation

5.  Hand off mechanisms facilitated by combinatorial RNA binding
...
the field of regeneration \[\@Lasko2012a; \@Lee2014c;
\@Magnusdottir2014d; \@Soldner2018d; \@Tadros2009c; \@Theunissen2017b\].
...
rapid generation time and genetic tractability \[\@Mattox1990;
\@Spradling1981b; \@Spradling1993b; \@Spradling2011f; \@Spradling1997e;
\@Xie2007a\]. These traits have facilitated the establishment of an
...
\[\@Goldstrohm2018c; \@Lin1997b; \@Reichardt2018d; \@Vessey2010b;
\@Zamore1999b; \@Zhang2015c\]. While both male and female *Drosophila*
...
elsewhere \[\@Barreau2008d; \@Fuller1998c; \@Spradling2011f;
\@Yamashita2005d; \@Zhao2002d\].
...
\[\@Kai2005; \@Twombly1996d; \@Xie2000; \@Xie1998d; \@Xie2007a\]. GSCs
...
transcribe all of the mRNAs necessary for the egg \[\@Lilly2005d;
\@Royzman1998\]. As this process ensues, the egg chambers and oocyte
increase in size as the supply of mRNAs and proteins is created and
deposited into the mature egg (Figure 1A) \[\@Lasko2012a;
\@Richter2011j\].
...
few examples, to mediate these critical transitions \[\@Cinalli2008d;
\@Rangan2008\]. Instead, the germline relies highly on
...
covered in detail in several recent reviews \[\@Granneman2004a;
\@Yelick2015a; \@You2015\]. Briefly, ribosomal DNA (rDNA) is present in
multicopy stretches within the genome; these areas of DNA are localized
to a subnuclear organelle called the nucleolus \[\@Karpen1988a;
\@Ritossa1965a; \@Schwarzacher1993\]. rDNA is transcribed into rRNA in
...
rRNA \[\@Granneman2011; \@Granneman2004a; \@Schafer2003a;
\@Tafforeau2013a\]. As these processing steps occur, the rRNA is
covalently modified and ribosomal proteins begin to interact with the
partially processed rRNA \[\@Agalarov2000; \@Deshmukh1993a;
\@Gumienny2017c; \@Jady2001c; \@Kiss2004c\]. When the rRNA is mostly
...
\[\@Lo2010a; \@Schafer2003a; \@Sloan2017e; \@Tschochner2003a;
\@Zemp2007\]. Errors at any of these steps can result in ribosome
biogenesis defects which in humans result in disease states known as
ribosomopathies \[\@Armistead2014a; \@Barlow2010a; \@Brooks2014b;
\@Higa-Nakamine2012o; \@Mills2017c; \@Sloan2017e\].
...
specific defects rather than pleiotropic phenotypes \[\@Brooks2014b;
\@Higa-Nakamine2012o; \@Mills2017c; \@Pereboom2011a; \@Yelick2015a\].
...
\[\@Brooks2014b; \@Morgado-Palacin2012a; \@Pereboom2011a;
\@WatanabeSusaki2014a\]. Indeed, a growing body of evidence is beginning
...
and are uncoupled during early oogenesis \[\@Sanchez2016h;
\@Zhang2014d\]. These attributes make *Drosophila* oogenesis an
...
machinery than they pass on to daughter cells \[\@Fichelson2009a;
\@Zhang2014d\]. In particular, Underdeveloped (Udd), an rRNA
...
proper differentiation \[\@Chen2003q; \@Chen2003o;
\@Lin1997b\].Consistent with this loss of *wcd* results in premature
...
cytokinesis of GSC daughters \[\@Mathieu2013d; \@Matias2015g;
\@Sanchez2016h\] . Somewhat surprisingly, despite their increased
...
required for ribosome biogenesis \[\@Grewal2007c; \@Magnuson2012c;
\@Martin2006a\]. In *Drosophila,* TORC1 activity is high in GSCs through
...
systems \[\@Kim2008b; \@Li2009n; \@Moreno-Torres2015; \@Noda2017;
\@Wei2009a\]. A downstream effector of mTORC1, La related protein 1
...
targets \[\@Fonseca2015a; \@Hong2017a; \@Lahr2017b; \[CSL STYLE ERROR:
reference with no printed form.\]\]; however, the same has yet to be
...
cap and 3' poly A tail in close proximity to each other \[\@Fukao2009c;
\@Martineau2008c; \@Preiss1998g\]. This interaction is mediated by cap
binding proteins such as eukaryotic initiation factor 4E (eIF4E) and the
poly-A binding protein (PABP)\[\@Eichhorn2016n; \@Kronja2014;
\@Subtelny2014a; \@TarunJr1997l\]. A longer poly-A tail and uninhibited
...
relies on precise translational control (Figure 4) \[\@Joshi2010l;
\@Slaidina2014h\]. As factors that interfere with translation such as
...
reviewed elsewhere and is not the focus of this chapter \[\@Flora2018k;
\@Slaidina2014h\]. Here, we outline how RBPs both collaborate as well
...
and Brain tumor (Brat) in CBs (Figure 4) \[\@Arvola2017n;
\@Goldstrohm2018c; \@Harris2011i; \@Reichardt2018d; \@Sonoda2001d;
\@Sonoda1999a\]. Nos, a well conserved RNA binding protein, has the
...
translation initiation (Figure 4) \[\@Arvola2017n; \@Harris2011i;
\@Sonoda2001d\]. While *brat* mRNA is expressed in the GSC, it is
...
critical differentiation promoting mRNAs \[\@Flora2018k; \@Lasko2012a;
\@Lasko2000; \@Slaidina2014n\].

Subsequent differentiation of the GSC daughters relies on several
factors to repress expression of *nos* mRNA \[\@Lasko2012a;
\@Lasko2000\]. Differentiation is initiated upon Bam expression in the
...
\[\@Kim-Ha1995i; \[CSL STYLE ERROR: reference with no printed form.\];
\@Schupbach1991f; \@Webster1997a\]. Downregulation of Pum expression is
...
**Figure 1.** (A) Schematic of *Drosophila* an ovariole. *Drosophila*
...
**Figure 2.** Schematic of the pathway that promotes alternative
splicing of *sxl* to generate the female *sex determining* variant in
the germline. Ovo-B promotes the transcription of *otu,* which enhances
splicing of *sxl*. The female-specific splice form of *sxl* is further
...
post-transcriptionally represses *nhp2* to promote cyst formation during
differentiation.

**Figure 3.** Schematic representing the germarium and plots
...
**Figure 4.** Schematic of combinatorial and dynamic translation
regulation in the *Drosophila *germarium. In the GSCs Nos, Pum and Twin
form a complex to inhibit the translation of differentiation mRNAs such
as *pgc*, which increases throughout oogenesis. Expression of Bam in the
...
specifically *nos*. As Nos protein levels decrease in the CB, Pum is
available to partner with Brat to repress the translation of
self-renewal genes and *pgc*. In cyst stages, Rbfox1 binds the *pum* 3'
UTR to inhibit its translation. Throughout oogenesis Bru and Cup
continuously block translation of *pgc*.
