...
library(captioner)
fig_nums <- captioner()
fig_nums("book_figure1", "(A) Schematic of *Drosophila* an ovariole. *Drosophila*
...
fig_nums("book_figure2", "Schematic of the pathway that promotes alternative
...
fig_nums("book_figure3", "Schematic representing the germarium and plots
...
fig_nums("book_figure4", "Schematic of combinatorial and dynamic translation
...
```{r, out.width="7.0527 in", out.height="3.5928 in", include=TRUE, fig.align="center", fig.cap=fig_nums("book_figure1"), echo=FALSE}
knitr::include_graphics("./figure/Book Chapter/Figure1.pdf")
```
