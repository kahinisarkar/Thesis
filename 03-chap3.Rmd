...
(ref:Oosite-1-long) \setlength\parindent{0pt}(**A**) Schematic illustrating developmental stages of germline
...
(ref:Oosite-2-long) \setlength\parindent{0pt}(**A**) Schematic of strategy used to obtain input mRNA samples and
...
<!-- (ref:Oosite-3-short) **Oo-site allows for visualization of dynamically regulated genes.** -->
(ref:Oosite-3-long) \setlength\parindent{0pt}(**A-B**) Visualization of expression of *RpS19b* over germline
...
(ref:Oosite-4-long) \setlength\parindent{0pt}(**A-A\'**) Violin plots of expression from bulk RNA-seq of genes 2-fold
...
<!-- (ref:Oosite-5-short) **GO-terms enriched from differentially expressed genes between genetically enriched developmental milestones.** -->
(ref:Oosite-5-long) \setlength\parindent{0pt}(**A-B**) Heatmaps of top five significant GO-terms by fold enrichment
...
<!-- (ref:Oosite-6-short) **Ord expression is controlled post-transcriptionally.** -->
(ref:Oosite-6-long) \setlength\parindent{0pt}(**A-B**) Visualization of expression of *ord* over germline development
...
(ref:Oosite-7-long) \setlength\parindent{0pt}(**A**) Violin plots of gene expression from RNA-seq of genes in the
...
<!-- (ref:Oosite-8-short) **Genes involved in double-strand break repair may be controlled post-transcriptionally.** -->
(ref:Oosite-8-long) \setlength\parindent{0pt}(**A**) Violin plot of expression of genes in the GO category
...
```{r oosite-fig-1, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-1-short)", fig.scap="(ref:Oosite-1-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Figure1.pdf")
```
...
```{r oosite-fig-2, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-2-short)", fig.scap="(ref:Oosite-2-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Supplemental_Figure1.pdf")
```
...
```{r oosite-fig-3, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-3-short)", fig.scap="(ref:Oosite-3-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Figure2.pdf")
```
...
```{r oosite-fig-4, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-4-short)", fig.scap="(ref:Oosite-4-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Supplemental_Figure2.pdf")
```
...
```{r oosite-fig-5, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-5-short)", fig.scap="(ref:Oosite-5-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Figure3.pdf")
```
...
```{r oosite-fig-6, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-6-short)", fig.scap="(ref:Oosite-6-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Figure4.pdf")
```
...
```{r oosite-fig-7, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-7-short)", fig.scap="(ref:Oosite-7-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Supplemental_Figure3.pdf")
```
...
```{r oosite-fig-8, fig.align="center", include=TRUE, out.height="8.490625 in", out.width="6.175 in", fig.align="center", fig.cap="(ref:Oosite-8-short)", fig.scap="(ref:Oosite-8-short)", echo=FALSE}
knitr::include_graphics("./figure/Oo_site/Figure5.pdf")
```
