...
upregulated (n=3, \* = $p \le 0.05$, \*\* = p\<0.01, \*\*\* = p\<0.001,
...
p\>0.05, \* = $p \le 0.05$, \*\* = p\<0.01, \*\*\* = p\<0.001.
...
ovariole; ns = p\>0.05, \* = $p \le 0.05$, \*\* = p\<0.01, \*\*\* =
p\<0.001.
...
with Student\'s t-test; N= 10 ovarioles; ns = p\>0.05, \* = $p \le 0.05$,
\*\* = p\<0.01, \*\*\* = p\<0.001.
...
t-test; N= 10 ovarioles; ns = p\>0.05, \* = $p \le 0.05$, \*\* = p\<0.01,
\*\*\* = p\<0.001.
