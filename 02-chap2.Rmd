...
and *CG9253* (**Figure 2.1B-C**) (**Supplemental Table 2.1**)
...
*athos*, and *porthos* was significantly downregulated **(Figure 2.2A)**.
We additionally drove RNAi of *aramis* and *athos* in the germline of
...
**(Figure 2.2B-E)**. To further investigate how these helicases promote
fertility, we depleted *aramis*, *athos*, and *porthos* in the germline
using the germline-driver *nanos*-*GAL4* (*nosGAL4*) in combination with
...
fusome-like structures proximal to the self-renewal niche **(Figure 2.1D-H; Figure 2.2E-E\'\'\'**). 
The cells in this cyst-like structurecontained ring canals, 
a marker of cytoplasmic bridges, suggesting that
they are indeed interconnected (**Figure 2.2F-F\'\'\'**) [@Zhang2014d].
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-1-short)', fig.scap='(ref:RiBi-F2-1-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 1.pdf")
```
...
(**Figure 2.2H-H\')** [@kaiEmptyDrosophilaStem2003]. Additionally, none
...
(**Figure 2.1D-G\'\')** [@McKearin1995b]. Thus, loss of *aramis*,
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-2-short)', fig.scap='(ref:RiBi-F2-2-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 1S.pdf")
```
...
(**A**) qPCR targeting *aramis*, *athos*, *porthos* relative to $\alpha$*-tub84B* to
...
humans (**Figure 2.1B**). The closest orthologs of Aramis, Athos, and
...
(**Figure 2.3A-C\'\'\'**) [@ochsFibrillarinNewProtein1985]. Aramis was
...
rRNA immunopurified with Aramis, Athos, and Porthos **(Figure 2.3D-D\'\', Figure 2.4A-A\'\')**.
...
control flies, consistent with nucleolar stress (**Figure 2.3B-C\'**).
...
the polysome peaks were reduced (**Figure 2.3E-E\'\'**). We found that
...
defective 40S ribosomal subunit biogenesis (**Figure 2.3E, E\'\'**, **Figure 2.4D)** [@chengSmallLargeRibosomal2019], 
whereas *athos* depletion
diminished the height of the 60S subunit peak compared to the 40S peaks,
characteristic of a 60S ribosomal subunit biogenesis defect (**Figure 2.3E\', Figure 2.4D\'**) [@chengSmallLargeRibosomal2019]. 
...
determine if *aramis*, *athos*, and *porthos* regulates ribosome
biogenesis, we performed trans-heterozygous crosses between *aramis*,
*athos*, and *porthos* and *shrb*. We observed the presence of stem-cyst
structures even heterozygotes mutants of *shrb*, consistent with
previous observations [@Matias2015g;@Sanchez2016h], and in
*aramis*, or *athos*, *porthos*. We found that in trans-heterozygous
germaria of a *shrb* mutant our genes of interest result in a more
frequent occurrence of stem-cysts than in their respective heterozygous
background consistent with their role in ribosome biogenesis (**Figure
S2E-L**). Taken together our findings indicate that these helicases
promote ribosome biogenesis in *Drosophila*.
...
(**Figure 2.1E, H**). First, we compared the mRNA profiles of *aramis*
...
used germline *bam* depletion as a control because it leads to the
accumulation of CBs with no abscission defects [@Flora2018l;@gilboaGermLineStem2003;@McKearin1995b;@ohlsteinEctopicExpressionDrosophila1997], whereas loss of *aramis*
...
\>\|1.5\|, FDR \< 0.05) (**Figure 2.10A, Supplemental Table 2.2**). Gene
...
enriched for GO terms related to stress response (**Figure 2.5A, Figure 2.6B**). The downregulated genes included *Cyclin A*, which is required
...
contrast the housekeeping gene *Actin 5C* was unaffected (**Figure 2.5B-C, Figure 2.6C-C\'**) [@Mathieu2013d;@Matias2015g]. We confirmed that
CycB was reduced in the ovaries of *aramis* germline RNAi flies compared
to *bam* germline RNAi flies by immunofluorescence (**Figure 2.5D-F**).
These changes to genes that promote cell cycle and cytokinesis were also
seen *aramis; bam* double depletions as the Biological Process GO-terms
we identified from targets downregulated in *aramis* RNAi were very
similar to those we identified from in *bam* RNAi; *aramis* RNAi
compared to their controls (**Figure 2.5A, Supplemental Table 2.3**). Similarly,
all of the GO-terms we identified in from upregulated genes are also
enriched GO terms from the double-knockdown upregulated targets (**Figure 2.6B, Supplemental Table 2.3**). 
Crucially, all the genes we refer to in the
manuscript such as *CycB*, *AurB,* and *CycA* are also targets in *bam*
RNAi; *aramis* RNAi. (**Figure 2.6B, Supplemental Table 2.3**). These
results suggest that *aramis* is required for the proper expression of
...
system (**Figure 2.6F-G'**) [@Mathieu2013d]. Unexpectedly, the
CycB::GFP fusion protein was not expressed in the *aramis-*depleted
germline, unlike the wild type (WT) germline (**Figure 2.6F-G**)
...
the *aramis*-depleted germaria expressed neither GFP nor RFP (**Figure 2.6F-H\'\'**). Double negative reporter expression is thought to indicate
...
express GFP that is not tagged with the degron (**Figure 2.6K**).
...
control, and *p53* null flies were used as negative controls (**Figure 2.6L-M**) [@Moon2018a]. In WT, we observed p53 expression in the
meiotic stages of germline but p53 expression in GSCs and CBs was
attenuated as previously reported (**Figure 2.5G-G\'\'**)
[@luMeioticRecombinationProvokes2010]. However, compared to WT
GSCs/CBs, we observed p53 expression in the stem cysts of the
*aramis-*depleted germline (**Figure 2.5G-I**). Similarly, we observed p53
expression in the stem cysts of *athos-* and *porthos-*depleted
germlines (**Figure 2.6N-O**), further supporting that reduced ribosome
biogenesis stabilizes p53. To determine if p53 stabilization is required
for the cell cycle arrest in *aramis*, *athos*, and *porthos-*depleted
germline cysts, we depleted *aramis*, *athos* and *porthos* in the
germline of *p53* mutants using germline specific knockdown. We observed
a partial but significant alleviation of the cyst phenotype, such that
spectrosomes were restored (**Figure 2.5J-L, Figure 2.6P-T**). This finding
indicates that p53 contributes to cytokinesis failure upon loss of
*aramis*, but that additional factors are also involved.
...
*porthos* (*Figure 2.5M-N*), in the remaining 3.6% of the time we observed
several single germline cells (XX-refer to the quant). Taken together,
we find that *aramis-*depleted germ cells display reduced ribosome
...
developmental controls, as well as gonads depleted for *aramis* in the
germline [@Flora2018k]. We plotted the ratios of polysome-associated
RNAs to total RNAs (**Figure 2.7A-A\'\', Supplemental Table 2.4**) and
...
developmental controls. Loss of *aramis* reduced the levels of these 87
downregulated transcripts in polysomes, without significantly affecting
their total mRNA levels (**Figure 2.7B, Figure 2.8A-A\'**). These 87
transcripts encode proteins mostly associated with translation including
ribosomal proteins (**Figure 2.7C)**. To validate that Aramis regulates
...
sequences [@buszczakCarnegieProteinTrap2007;@Zhang2014d]. We
observed reduced levels of RpS2::GFP in germlines depleted of *aramis*
but not in those depleted of *bam* (**Figure 2.7D-F**). RpS2::GFP
expression is also reduced in *bam* RNAi, *aramis* RNAi double germline
knockdown compared to *bam* RNAi (**Figure 2.8B-D**). To ensure that
...
[@Sanchez2016h]. We observed that global translation in the germlines
of ovaries depleted of *aramis* was not reduced compared to single cells
of control ovaries or *bam* **(Figure 2.7G-J)**. Notably, the regulation
...
(**Supplemental Table 2.5**). Thus, loss of *aramis* results in reduced
...
single ribosomal proteins (**Figure 2.8E-G\'**). We reason that individual
...
was reduced in polysomes upon loss of *aramis* in the germline (**Figure 2.7C**). 
...
(**Figure 2.9A-A\'\')**. Non1::GFP levels were reduced in the *aramis*,
*athos* or *porthos-*depleted stem cysts compared to the CBs that
accumulated upon *bam*-depletion (**Figure 2.9B-D, Figure 2.10C-F**),
...
(**Figure 2.9A-A\'\'**, **Figure 2.10A-B\'**). Non1 was highly expressed in egg
...
germline-depletion of *aramis*, *athos*, and *porthos* (**Figure 2.9E-F, H, Figure 2.10G-I**). In addition, we found that loss of *p53* from
...
(see Methods) [@rorthGal4DrosophilaFemale1998]. We found that
restoring *Non1* expression in the *aramis*, *athos*, or *porthos
...
of Non1 alone did not cause any noticeable defect (**Figure 2.9I-K, Figure 2.10J-N**). 
Taken together, we conclude that Non1 can partially suppress
the cytokinesis defect caused by germline *aramis* depletion.
...
of target genes compared to non-target genes [@Bailey2006a] and
identified a polypyrimidine motif in the 5\'UTRs of most target genes
(UCUUU; E-value: 6.6e^-094^). This motif resembles the previously
...
6A**) [@boleyNavigatingMiningModENCODE2014;@chenComparativeValidationMelanogaster2014;@dossantosFlyBaseIntroductionDrosophila2015]. Of the 87 target genes,
...
within the first 50 nt of their TSS (**Figure 2.11B-C**). In mammals, it
...
(**Figure 2.7C, Supplemental Table 2.6**). To determine if the putative TOP
...
reporter (**Figure 2.11D**). As a control, we created a construct in which
the polypyrimidine sequence was mutated to a polypurine sequence
referred to as the Mut-TOP reporter (**Figure 2.11D**).

In *Drosophila*, TORC1 activity increases during meiotic cyst stages
...
**(Figure 2.11E-F\'\')**, suggesting that the WT-TOP reporter is sensitive to
...
reporter **(Figure 2.12A-E)**. Additionally, to attenuate TORC1 activity,
...
Mutant-TOP reporter did not show a decrease in expression **(Figure 2.12F-J)**. 
...
reporter into *bam* and *aramis*, *athos*, and *porthos* germline RNAi
...
*bam* RNAi ovaries **(Figure 2.11F-G, J)**. In contrast, the Mutant-TOP
reporter was only reduced by 1.6-fold in the germline of *aramis* RNAi
ovaries compared to *bam* RNAi ovaries **(Figure 2.11H-J)**. We observed
the same trend for *athos* and *porthos* (**Figure 2.12K-Q**). This
...
expressed throughout all stages of oogenesis including in GSCs **(Figure 2.14A-A\')**.
...
of increasing concentrations of Larp-DM15 **(Figure 2.13A-A\', Figure 2.14B)**, and this shift was abrogated when the TOP sequences were mutated
to purines **(Figure 2.14C-C\').** To determine if Larp interacts with
TOP-containing mRNAs *in vivo*, we immunopurified Larp::GFP::3XFLAG from
the ovaries of the gene-trap line and performed RNA-seq (**Figure 2.14D**). We uncovered 156 mRNAs that were bound to Larp, and 84 of these
were among the 87 *aramis* translationally regulated targets, including
*Non1*, *RpL30*, and *RpS2* (**Figure 2.13B-C, Supplemental Table 2.7**).
...
RNAi compared to developmental control *bam* RNAi (**Figure 2.14E-G**).
Larp protein is also not expressed at higher levels in *bam* RNAi;
*aramis* RNAi germline knockdown compared to *bam* RNAi as a control
(**Figure 2.14H-I**). We found that Larp binding to *aramis* target mRNAs
*Non1* and *RpL30* was increased in *aramis* RNAi ovaries compared to
*bam* RNAi ovaries (**Figure 2.13D, Figure 2.14J**). In contrast, a
non-target mRNA that does not contain a TOP motif, *alpha-tubulin* mRNA,
did not have a significant increase in binding to Larp in *aramis* RNAi
ovaries compared to *bam* RNAi ovaries. Overall, these data suggest that
reduced rRNA biogenesis upon loss of *aramis* increases Larp binding to
the TOP-containing mRNAs *Non1* and *RpL30*.
...
precise phosphorylation sites of *Drosophila* Larp, to our knowledge,
are currently unknown [@Hong2017a]. To circumvent this issue, we
overexpressed the DM15 domain of Larp which we showed binds the *RpL30*
and *Non1* TOP motifs *in vitro* (**Figure 2.13A-A\'**), and, based on
...
extending from the niche (**Figure 2.13E-F\'**)**.** Additionally, ovaries
overexpressing Larp-DM15 had 32-cell egg chambers, which were not
observed in control ovaries (**Figure 2.14K-K\'**). The presence of 32-cell
...
arrest and loss of stem cell differentiation (**Figure 2.13G**).
...
is dependent on Raptor and TOP-reporter expression is repressed by Nprl3 (**Figure 2.12A-J**). 
...
compared to the *Non1* TOP site (**Figure 2.14B**). 
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-3-short)', fig.scap='(ref:RiBi-F2-3-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 2.pdf")
```
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-4-short)', fig.scap='(ref:RiBi-F2-4-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 2S.pdf")
```
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-5-short)', fig.scap='(ref:RiBi-F2-5-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 3.pdf")
```

<!-- **Figure 2.5. Athos, Aramis, and Porthos are required for cell cycle progression during early oogenesis.**  -->
(**A**) Bar plot representing the
...
(**C**) *aurora B* in ovaries depleted of *aramis* compared to the
...
```{r, include=TRUE, out.height="5.409091 in", out.width="7 in", fig.align="center", fig.cap='(ref:RiBi-F2-6-short)', fig.scap='(ref:RiBi-F2-6-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 3S.pdf")
```
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-7-short)', fig.scap='(ref:RiBi-F2-7-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 4.pdf")
```
...
(**A-A\'\'**) Biplots of poly(A)+ mRNA Input versus polysome
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-8-short)', fig.scap='(ref:RiBi-F2-8-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 4S.pdf")
```
...
(**A-A\'**) Volcano plot of mRNA levels from poly(A)+ mRNA
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-9-short)', fig.scap='(ref:RiBi-F2-9-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 5.pdf")
```
...
(**A-A\'**) Confocal images of Non1::GFP germaria
...
```{r, include=TRUE, out.height="5.409091 in", out.width="7 in", fig.align="center", fig.cap='(ref:RiBi-F2-10-short)', fig.scap='(ref:RiBi-F2-10-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 5S.pdf")
```
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-11-short)', fig.scap='(ref:RiBi-F2-11-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 6.pdf")
```
...
<!-- **Figure 2.11. Aramis regulated mRNAs contain a TOP motif.**  -->
(**A**) Genome browser tract of *RpL30* locus in ovary
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-12-short)', fig.scap='(ref:RiBi-F2-12-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 6S.pdf")
```
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-13-short)', fig.scap='(ref:RiBi-F2-13-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 7.pdf")
```
...
(**A-A\'**) EMSA of Larp-DM15 and the leading 42 nucleotides of
...
```{r, include=TRUE, out.height="8.9375 in", out.width="6.5 in", fig.align="center", fig.cap='(ref:RiBi-F2-14-short)', fig.scap='(ref:RiBi-F2-14-short)', echo=FALSE}
knitr::include_graphics("./figure/Ribosome Biogenesis/Ribosome Biogenesis 7S.pdf")
```
**\
**
...
**Supplemental Table 2.2. Differential expression analysis fromRNAseq of ovaries depleted of *aramis* in the germline compared to a developmental control.**
...
DEseq2 output from RNAseq of ovaries depleted of *bam* and *aramis* in the germline compared to
...
Results of polysome-seq from ovaries depleted of *aramis* in the germline,
...
*nosGAL4* and nosGAL4\>*aramis* RNAi germaria. A manual threshold was
...
<!-- +==================================+==================================+ -->
<!-- | \*\*RpL30 control gene block     | GCGCGCGAATTCTAATACGACTCAC        | -->
<!-- | (with 3\' HDV)                    | TATA**GAAAAGCCATTGTCAGCC**      | -->
<!-- |                                  |  **GACGAAGTGCTTTAACCCAAACTA**    | -->
<!-- |                                  | GGGTCGGCATGGCATCTCCACCT          | -->
<!-- |                                  | CCTCGCGGTCCGACCTGGGCTAC          | -->
<!-- |                                  |TTCGGTAGGCTAAGGGAGAAGCTT          | -->
<!-- |                                  |GGCACTGGCCGTCGTTT                 | -->
<!-- +----------------------------------+----------------------------------+ -->
<!-- | Non1 control                     | GCGCGCGAATTCTAATACGAC            | -->
<!-- |                                  | TCACTATA**GGAAAAAGGA**           | -->
<!-- | Forward                          | **ATACGAAGCTGACA**               | -->
<!-- +----------------------------------+----------------------------------+ -->
<!-- | Non1 control                     | **AAGCAAAAACACCACGCGGTG**        | -->
<!-- |                                  | **TCAGCTTCGTATTCCTTTTTC**        | -->
<!-- | Reverse                          | CTATAGTGAG                       | -->
<!-- +----------------------------------+----------------------------------+ -->
...
1 mM DTT, 0.5 µg tRNA (Ambion), 1 µg BSA (Invitrogen), and \<90 pM RNA.
...
Dixon test with a cutoff of p\<0.05. Remaining technical replicates were
averaged, and the IP Input Ct value, the log~2~ of the Input dilution
...
Finally, fold increase of IP from *aramis* RNAi over *bam* RNAi was
