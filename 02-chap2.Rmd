...
(**A**) targeting *aramis*, *athos*, *porthos* relative to $\alpha$*-tub84B* to
...
system (**Figure 2.6D-D\'**) [@Mathieu2013d]. Unexpectedly, the
CycB::GFP fusion protein was not expressed in the *aramis-*depleted
germline, unlike the wild type (WT) germline (**Figure 2.6E-E\'**)
...
express GFP that is not tagged with the degron (**Figure 2.6I-I\'**).
...
control, and *p53* null flies were used as negative controls (**Figure 2.6J-K**) [@Moon2018a]. In WT, we observed p53 expression in the
...
germlines **(Figure 2.6L-M)**, further supporting that reduced ribosome
...
spectrosomes were restored (**Figure 2.5J-L, Figure 2.6N-Q**). This finding
